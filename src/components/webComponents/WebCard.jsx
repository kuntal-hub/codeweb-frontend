    ...
    return (
        ...
        normHoverableEle transition duration-6500 ease-in-out'>
            <div className='hoverableEle transition duration-6500 ease-in-out m-0 p-0'>
                <Link to={`/web/${web._id}`} onClick={() => {
                    if (showPinedItems) {
                        dispatch(setShowPinedItems(false))
                    }
                }}>
                    <img src={web.image} alt="img" className='w-full rounded-lg' /></Link>
                <Link to={`details/${web._id}`} onClick={() => {
                    if (showPinedItems) {
                        dispatch(setShowPinedItems(false))
                    }
                }}
            ...
            <div className='flex flex-nowrap justify-start py-4'>
                <Link to={`/${web.owner.username}`} onClick={() => {
                    if (showPinedItems) {
                        dispatch(setShowPinedItems(false))
                    }
                }}>
            ...
            <div className='normShowingEle transition duration-500 ease-in-out'>
                <div className='flex flex-nowrap justify-between w-full'>
                    <div className='flex flex-nowrap justify-start'>
                        ...
                        <Link to={`details/${web._id}#comments`} onClick={() => {
                            if (showPinedItems) {
                                dispatch(setShowPinedItems(false))
                            }
                        }}
                        ...
                        <Link to={`/view-full/${web._id}`} onClick={() => {
                            if (showPinedItems) {
                                dispatch(setShowPinedItems(false))
                            }
                        }}
