...
export default function CssAddons() {
  ...
  return (
    <div className='w-full h-full-50px rounded-b-lg overflow-y-auto'>
        ...
        <div className='w-full px-3 py-5 md:px-10 flex flex-nowrap justify-between'>
            <input type="text"
            value={link}
            placeholder=' <link rel="stylesheet" href="https://yourWebSite.com/style.css" />'
        ...
        <div className='w-full px-3 py-5 md:px-10 flex flex-nowrap justify-between'>
                <input type="text"
                value='<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0" />'
                readOnly={true}
