...
import "../../cssFiles/retroBG.css";

export default function RetroBG({text}) {
    return (
        <div className='w-screen h-screen m-0 p-0'>
            <div id="retrobg" className='w-full h-full'>
                <div id="retrobg-sky">
            ...
            <div className='grid place-content-center w-screen h-screen fixed top-0 left-0 right-0'>
                <p className='text-white text-3xl md:text-[40px] text-center font-bold font-serif mt-36'>
                    {text}
                </p>
            </div>
